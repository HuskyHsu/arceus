    ...
    <PokemonContext.Provider value={pokemon}>
      ...
      >
        ...
        >
          ...
          <div
            className="w-full h-12 md:pl-40 flex items-center justify-center md:justify-start gap-4 text-white bg-no-repeat bg-contain"
            style={{
              clipPath: clipPath,
        ...
        >
          ...
          <div
            className={clsx(
              "absolute",
              "w-full",
              isMobile ? "h-60 top-0" : "h-28 bottom-0",
